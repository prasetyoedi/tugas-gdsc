const dataUrl = 'https://prasetyoedi.github.io/portfolio/assets/data.json'
...
function renderItem(items) {
        ...
        <div data="${item.id}" class="col l-2-4 m-3 c-6 home-product-item">
            <a class="home-product-item-link" href="#">
                <div class="home-product-item__img" style="background-image: url(./assets/img/home/produk.jpeg);"></div>
                <div class="home-product-item__info">
                    <h4 class="home-product-item__name">${item.name}</h4>
                    <div class="home-product-item__price">
                        <p class="home-product-item__price-old">Rp ${item.oldPrice}</p>
                        <p class="home-product-item__price-new">Rp ${item.newPrice}</p>
                    ...
                    <div class="home-product-item__footer">
                        ...
                        <div class="home-product-item__saled">Terjual ${item.saled}</div>
                    </div>
                ...
                <div class="home-product-item-footer">Produk Serupa</div>
            </a>
        </div>`;
        })
